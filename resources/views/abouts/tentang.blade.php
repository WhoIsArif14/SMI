        ...
        <div class="bg-white rounded-lg shadow-lg p-8 mb-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div>
                    ...
                    <p class="text-lg text-gray-700 mb-4 text-justify">
                        {{-- Teks hijau diubah menjadi kuning emas (amber) --}}
            ...
            <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg shadow-lg p-8 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {{-- Head Office (Tetap Biru) --}}
                    <div
                        class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <div class="flex items-start">
                            <svg class="w-5 h-5 text-gray-500 mr-2 mt-1 flex-shrink-0" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    {{-- Representative Office Semarang (Hijau diubah menjadi Kuning Emas) --}}
                    <div
                        class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2">
                        <div class="flex items-center mb-4">
                        ...
                        <div class="flex items-start">
                            ...
                            <p class="text-gray-700 font-medium">Ruko Bringin, Jl KRT Wongsonegoro (Depan SMAN 8 Semarang)
                                Jawa Tengah</p>
                        </div>
                    </div>

                    {{-- Representative Office Jakarta (Ungu diubah menjadi Kuning Emas) --}}
                    <div
                        class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2">
                        <div class="flex items-center mb-4">
                            <div class="w-12 h-12 bg-amber-100 rounded-full flex items-center justify-center mr-4">
                        ...
                        <div class="flex items-start">
                            ...
                            <p class="text-gray-700 font-medium">Kebagusan City 1 KC 28 Jalan Raya Baung Kebagusan Pasar
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    {{-- Trusted (Hijau diubah menjadi Kuning Emas) --}}
                    ...
                    {{-- Innovative (Ungu diubah menjadi Kuning Emas) --}}
                    <div class="text-center p-6 rounded-lg bg-amber-50 hover:bg-amber-100 transition-all duration-300">
                        <div class="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-4">
                            <svg class="w-8 h-8 text-amber-600" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg shadow-lg p-8 text-white text-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    <div class="bg-blue-700 rounded-lg p-6">
                        <div class="flex items-center justify-center mb-4">
                            <svg class="w-8 h-8 text-blue-200 mr-3" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <p class="text-blue-100 text-lg">
                            {{ config('social.contact.email', 'info@selarasmitraintegra.com') }}</p>
                    </div>
                ...
                <div class="mt-12">
                    <a href="{{ route('contact') }}"
                        class="inline-block bg-yellow-400 text-blue-800 font-bold px-8 py-4 rounded-full text-lg hover:bg-yellow-300 transition duration-300 shadow-lg">
