        ...
        <div class="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-yellow-100 p-6 rounded-lg shadow-md text-center">
                    <h2 class="text-xl font-semibold text-yellow-800 mb-3">Tentang Kami</h2>
                    <p class="text-gray-600 mb-4">Materi presentasi mengenai para ahli di bidang psikologi industri dan organisasi.</p>
                    <a href="{{ route('abouts.tentang') }}" class="inline-flex items-center px-4 py-2 bg-yellow-400 text-white font-semibold rounded-lg hover:bg-yellow-500 transition duration-300">
