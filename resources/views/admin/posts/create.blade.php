            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.posts.store') }}" enctype="multipart/form-data">
                        ...
                        {{-- Gambar Thumbnail --}}
                        <div class="mb-4">
                            <label for="image" class="block text-sm font-medium text-gray-700">Gambar Thumbnail (Opsional)</label>
                        ...
                        <div class="mb-4 flex items-center">
                            ...
                            <label for="is_published" class="ml-2 text-sm font-medium text-gray-700">Publikasikan Sekarang</label>
                        </div>
