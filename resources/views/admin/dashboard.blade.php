        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <p class="text-gray-700 dark:text-gray-300">Ini adalah panel administrasi Anda. Dari sini Anda bisa mengelola konten website.</p>

                    <div class="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {{-- Card untuk Berita --}}
                        <div class="bg-blue-100 dark:bg-blue-700 p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                            <h3 class="text-xl font-semibold text-blue-800 dark:text-blue-100 mb-2">Manajemen Berita</h3>
                            <p class="text-blue-700 dark:text-blue-200 mb-4">Kelola postingan berita dan artikel.</p>
                            <a href="{{ route('admin.posts.index') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                Lihat Berita
                        ...
                        <div class="bg-purple-100 dark:bg-purple-700 p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                            ...
                            <p class="text-purple-700 dark:text-purple-200 mb-4">Kelola daftar klien dan logo mereka.</p>
