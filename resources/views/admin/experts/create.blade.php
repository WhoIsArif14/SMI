                    ...
                    <form action="{{ route('admin.experts.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="experience" id="experience" rows="4" 
                                    ...
                                    placeholder="Deskripsikan pengalaman kerja secara singkat dan menarik..."
                                    required>{{ old('experience') }}</textarea>
                                <p class="mt-1 text-sm text-gray-500">Maksimal 200 karakter untuk ringkasan yang akan ditampilkan di halaman utama</p>
                                @error('experience')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            {{-- Biografi Lengkap --}}
                            <div>
                                <label for="full_bio" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Biografi Lengkap
                                </label>
                                ...
                                <p class="mt-1 text-sm text-gray-500">Informasi lengkap yang akan ditampilkan saat pengguna memilih "Lihat Selengkapnya"</p>
                                @error('full_bio')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="pb-6">
                            ...
                            <div class="flex items-center space-x-6">
                                <div class="shrink-0">
                                    <div id="photo-preview" class="w-24 h-24 rounded-full bg-gradient-to-br from-teal-400 to-teal-600 flex items-center justify-center text-white font-bold text-xl shadow-lg">
            ...
            photoInput.addEventListener('change', function(e) {
                ...
                if (file) {
                    ...
                    reader.onload = function(e) {
                        photoPreview.innerHTML = `<img src="${e.target.result}" alt="Preview" class="w-24 h-24 rounded-full object-cover">`;
                    };
