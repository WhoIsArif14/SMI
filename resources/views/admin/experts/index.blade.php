<x-app-layout>
    {{-- Bagian header HANYA berisi judul halaman --}}
    <x-slot name="header">
                            ...
                            @forelse ($experts as $expert)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-teal-100 text-teal-800">{{ $expert->category }}</span>
                                    </td>
