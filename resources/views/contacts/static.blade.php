...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 relative overflow-hidden">
        ...
        <div class="absolute inset-0 overflow-hidden">
            ...
            <div
                class="absolute bottom-20 right-20 w-40 h-40 bg-gradient-to-br from-pink-400 to-yellow-400 rounded-full opacity-15 animate-pulse delay-1000">
            </div>
            <div
                class="absolute top-1/2 left-10 w-24 h-24 bg-gradient-to-br from-green-400 to-blue-400 rounded-full opacity-25 animate-pulse delay-2000">
            </div>
            <div
                class="absolute bottom-1/3 right-10 w-28 h-28 bg-gradient-to-br from-orange-400 to-red-400 rounded-full opacity-20 animate-pulse delay-3000">
            </div>
        </div>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    contactForm.addEventListener('submit', function(e) {
                        ...
                        const whatsappMessage =
                            `Halo SMI,%0A%0ANama: ${name}%0AEmail: ${email}%0ATelepon: ${phone}%0A%0APesan:%0A${message}`;
                    ...
                    const socialLinks = document.querySelectorAll(
                        'a[href*="wa.me"], a[href*="instagram"], a[href*="linkedin"], a[href*="facebook"]');
